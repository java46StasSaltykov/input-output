...
public class CompanyImpl implements Company {
	...
	public void addEmployee(Employee empl) throws Exception {
		...
		employeesDepartment.computeIfAbsent(empl.getDepartment(), v -> new ArrayList<>()).add(empl);
	...
	public Iterable<Employee> getEmployeesSalary(int salaryFrom, int salaryTo) {
		...
		return employeesSalary.subMap(salaryFrom, true, salaryTo, true).values().stream().flatMap(Collection::stream)
				.toList();
	}
